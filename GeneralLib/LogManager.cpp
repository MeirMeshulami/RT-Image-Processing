...
const std::filesystem::path kLogsFilePath = R"(C:/MobileyeProjectTools/Output/logs/log.txt)";
#elif __linux__
// Linux-specific code (including WSL)
const std::filesystem::path kLogsFilePath = R"(/mnt/c/MobileyeProjectTools/Output/logs/log.txt)";
#endif
